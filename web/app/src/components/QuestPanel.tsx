...
const NEWBIE_QUESTS: string[] = [
  ...
  "点击大门，选择「敲门」",
  "点击游鲲翼，选择「给予」，把葫芦交给他",
  "点击游鲲翼，选择「打听」，依次询问：此地 → 姓名 → 葫芦 → 闯荡江湖（共4步，按顺序点击）",
  "点击阿姝，选择「跟随」",
  "在动作栏点击「脱下布衣」，再点击「洗澡」",
  "在动作栏点击「穿上布衣」，再去正厅点击游鲲翼「打听」——闯荡江湖",
  "前往尚武堂，点击武师选择「切磋」",
  "回到厢房，在动作栏点击「睡觉」恢复体力",
  "点击游鲲翼「打听」——闯荡江湖！",
  "打开菜单中的「地图」查看票号位置，前往票号取钱",
  "前往票号，在动作栏点击「取款」，输入金额确认",
  "在动作栏点击「逛店」购买金创药，在行囊中点击药物「服用」",
  "点击游鲲翼「打听」——闯荡江湖！！",
  "点击武师选择「拜师」",
  "帮武师去铁匠铺「逛店」买钢剑、去酒铺「逛店」买烧刀子，点击武师「给予」交出",
  "再去酒铺「逛店」买鸡腿、杂货铺「逛店」买食盒，点击食盒「放入物品」，再点击武师「给予」交出",
  "点击武师选择「拜师」，再选择「查看技能」",
  "点击武师「学艺」，学习所有基本和高级功夫到 5 级",
  ...
  "点击游鲲翼「打听」——闯荡江湖！！！！",
  "前往藏书阁，点击书架取书，在行囊中点击书籍「阅读」（若还不识字，先去武师处学习读书写字）",
  "点击游鲲翼「打听」——闯荡江湖！！！！！",
